...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LED_ERR_Pin|LED1_Pin|LED2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(WQ_NSS_GPIO_Port, WQ_NSS_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : M1_C1_Pin */
  GPIO_InitStruct.Pin = M1_C1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(M1_C1_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(PHOTO_RES_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : RESET_LORA_Pin LORA_NSS_Pin LIS_NSS_Pin */
  GPIO_InitStruct.Pin = RESET_LORA_Pin|LORA_NSS_Pin|LIS_NSS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
